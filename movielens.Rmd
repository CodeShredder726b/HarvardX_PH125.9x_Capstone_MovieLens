...
## Tuning
After searching for each tuning parameter individualy these are the final tuning parameters:
...
first tried with only the genre_bias tuning, all other were 1 * sum(rating - movie_avg)/n(). This resulted in the best tuning parameter around 0. So the genre_bias effect is reduced  having almost 0 effect. So in the end I removed it (commented it out for the history sake). -> genre_bias tune parameter: 0.0055
